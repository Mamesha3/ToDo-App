  ...
  return (
    <div className="p-4 flex items-center justify-between bg-green-400 text-amber-50">
      ...
      {isMenuOpen && <div className="sm:hidden relative">
        <div className="fixed inset-0 bg-black/50 z-50">{user?.name}</div>
        <div className="fixed top-0 left-0 w-64 h-full bg-white z-50">
          ...
          <div className="flex flex-col items-start gap-4 mt-20 px-3 w-full">
            <button title="profile" className="shadow-sm cursor-pointer hover:shadow-lg p-2 rounded-lg hover:border hover:border-amber-500 font-semibold transition-all duration-75 text-black flex items-center gap-2 w-full">
              <UserPen />
              <h3>Profile</h3>
            </button> 

            <button title="Home" className="shadow-sm cursor-pointer hover:shadow-lg p-2 rounded-lg hover:border hover:border-amber-500 font-semibold transition-all duration-75 text-black flex items-center gap-2 w-full">
              <Home />
              <h3>Home</h3>
            </button> 
